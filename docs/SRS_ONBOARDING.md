...
| CC-REQ-TOUR-EDIT-005 | Tour showcases minimap navigation | • Step 5: Target minimap component at bottom<br>• Spotlight on minimap bar and view window<br>• Description: "The minimap shows your entire timeline. Click or drag the view window to navigate quickly"<br>• Mentions density heatmap visualization | TBD | TBD |
