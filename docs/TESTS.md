...
- **Spec files:** 16 passing / 42 failing (58 total)
- **Individual tests:** 45 passing / 120 failing (165 total)
<!-- /GENERATED:RUN-SUMMARY -->
...
<!-- GENERATED:DETAILS -->
| Test File | Summary | Category | Linked Requirements | Status (2025-09-29) |
|---|---|---|---|---|
...
| v5/22-minimap-basic.spec.ts | Validates minimap basic behavior and empty states | Minimap Tests | CC-REQ-MINIMAP-001 | ❌ Fail — Page loads correctly without minimap when no events |
...
| **UI & Panels Tests** | | | | |
| v5/50-panels-visibility.spec.ts | Verifies panels visibility, Create overlay behavior, Dev panel sizing | UI & Panels Tests | CC-REQ-UI-001 | ❌ Fail — Create opens centered authoring overlay (replacing side Create panel) |
...
| v5/55-navigation-enhancements.spec.ts | Checks enhanced navigation shortcuts, command palette, breadcrumbs | UI & Panels Tests | CC-REQ-UI-003 | ❌ Fail — command palette opens with Ctrl+K and searches commands |
