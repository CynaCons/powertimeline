/**
 * Temporary Firebase config with hardcoded values for testing
 * Use this if .env.local isn't loading
 */
...
// Hardcoded Firebase configuration (TEMPORARY - for testing only)
